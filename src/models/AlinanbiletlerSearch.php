...
/**
 * AlinanbiletlerSearch represents the model behind the search form of `furkanaydgn\deneme\models\Alinanbiletler`.
 */
class AlinanbiletlerSearch extends Alinanbiletler
{
    /**
     * {@inheritdoc}
     */
